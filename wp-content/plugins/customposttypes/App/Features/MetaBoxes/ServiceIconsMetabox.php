...
class ServiceIconsMetabox
{
    public static $slug = 'service_icons_metabox';
    ...
    public static function render()
    {
        ...
        $icon = extract_data_attr('service_icon', $data);
        ...
        view('metaboxes/service-icons', compact('icon'));
    }
    ...
    public static function save($post_id)
    {
        ...
        if (count($_POST) != 0) {
            ...
            $data = [
                ...
                'service_icon'  => post_data('service_icon', $_POST)
            ];
