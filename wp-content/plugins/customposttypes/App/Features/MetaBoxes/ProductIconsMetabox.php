...
class ProductIconsMetabox
{
    public static $slug = 'product_icons_metabox';
    ...
    {
        $screen = [ProductPostType::$slug];

        add_meta_box(
            self::$slug,                // Unique ID
            __("Icone du produit"),     // Box title
    ...
    public static function render()
    {
        ...
        $icon = extract_data_attr('product_icon', $data);
        ...
        view('metaboxes/product-icons', compact('icon'));
    }
    ...
    public static function save($post_id)
    {
        ...
        if (count($_POST) != 0) {
            ...
            $data = [
                ...
                'product_icon'  => post_data('product_icon', $_POST)
            ];
